# -*- coding: utf-8 -*-
"""Configuration for Check Family Params (Shift+Click)"""
...
current_text = getattr(cfg, 'check_params_raw', DEFAULT_TEXT)

xaml_layout = """
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"
        Title="Check Params Settings" Height="450" Width="800" 
    ...
    <Grid Margin="10">
        ...
        <TextBlock Text="Paste your REQUIRED Shared Parameters file contents here:" 
                   Grid.Row="0" Margin="0,0,0,2" FontWeight="Bold"/>
        <TextBlock Text="Families will be audited to ensure they contain these parameters. Headers/groups are ignored." 
...
class SettingsDialog(forms.WPFWindow):
    ...
    def save_clicked(self, sender, args):
        ...
        cfg.check_params_raw = "\n".join(valid_lines)
        script.save_config()
        
        forms.alert("Settings Saved!\n\nAuditing for {} required parameter(s).".format(len(valid_lines)), title="Success")
        self.Close()
